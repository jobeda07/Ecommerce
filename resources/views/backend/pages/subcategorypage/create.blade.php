...
<div class="bg-secondary rounded h-100 p-4">
                            <center><h2 class="mb-4">SubCategory Create</h2></center>
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" required name="subcat_name" class="form-control" id="floatingInput"
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" required name="subcat_status" class="form-control" id="floatingInput"
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" required name="subcat_description" placeholder="Leave a comment here"
